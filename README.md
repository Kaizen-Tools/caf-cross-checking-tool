...
3. Upload the matching issue Excel export.
4. Enter the issue number.
5. Run the cross-check.
6. Review the colour-coded checklist and any flagged SKU quantity differences.
...
- The entered requisition and issue numbers must match.
- Uploaded filenames are ignored; only the entered document numbers are validated.
